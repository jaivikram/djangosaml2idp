...
SAML_CONFIG = {
    ...
    'entityid': 'http://192.168.56.101:8001/saml2/metadata/',

    'service': {
        'sp': {
            'name': 'http://192.168.56.101:8001/saml2/metadata/',
            'endpoints': {
                'assertion_consumer_service': [
                    ('http://192.168.56.101:8001/saml2/acs/', saml2.BINDING_HTTP_POST),
                ],
                'single_logout_service': [
                    ('http://192.168.56.101:8001/saml2/ls/', saml2.BINDING_HTTP_REDIRECT),
                    ('http://192.168.56.101:8001/saml2/ls/post/', saml2.BINDING_HTTP_POST),
                ],
            },
